...
const editHandler = async (e) => {
  const reviewId = e.target.id.slice(2);
  const reviewContainer = document.querySelector("#rd" + reviewId).parentNode
    .parentNode;
  ...
  document
    .querySelector("#ec" + reviewId)
    .addEventListener("click", cancelEditHandler);
  document
    .querySelector("#es" + reviewId)
    .addEventListener("click", submitEditHandler);
};
